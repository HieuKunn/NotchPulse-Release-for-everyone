...
- **Unified Dynamic Island Inline Expansions**: Media playback, Live Activity, and inline HUD indicators now expand gracefully with full, balanced dimensions on Dynamic Island mode matching the physical Notch layout.
- **Instant Zero-Delay Face ID Icon**: The Face ID icon appears instantaneously at 0ms upon hover, eliminating blank frames.
- **Harmonized Open Margins**: Balanced inner horizontal and bottom padding on Open Notch so album art and player controls have consistent, generous black border clearance matching Dynamic Island.
