...
## 🔒 Biometric Fluid Unlock & Lock Screen Stability
...
- **Lock Screen Transition Safety**: Optimized window level initialization during display lock/unlock state transitions to prevent unexpected app termination.

## 🎛️ Continuous Volume & Brightness HUDs & UI Polish
...
- **Smart Snug HUD & Notch Margins**: Adjusted open notch inner padding, header icon margins, and inline HUD spacing so album art, track details, and system HUDs are cleanly framed without clipping against the physical MacBook notch.
